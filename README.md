...
## 🌟 Related Projects
- **[PXMeter](https://github.com/bytedance/PXMeter/)** is a comprehensive toolkit for evaluating the quality of structures generated by biomolecular structure prediction models, with support for proteins, nucleic acids, and small molecules. The evaluation of Protenix is based on PXMeter.
...
## Updates
### 🎉 Model Update
- 2025-07-16: Several smaller and more efficient models have been released alongside the main checkpoint. Users can choose the appropriate variant based on their hardware and performance requirements. See our [paper]() and [model configs](./configs/configs_model_type.py) for more information. 
- 2025-07-16: [***Constraint feature***](docs/infer_json_format.md#constraint) of Protenix is released! Added **atom-level contact** and **pocket** constraints, significantly improving performance in our evaluations.
