...
# python -c "from protenix.model.layer_norm.layer_norm import FusedLayerNorm"
# echo finished building fused layer norm
...
input_json_path="./holofold_runs/fe/test.json"
dump_dir="./output/fe"
